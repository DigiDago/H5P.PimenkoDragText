...
/**
 * @typedef {object} H5P.PimenkoDragTextEvent
 * @property {HTMLElement} element The element being dragged
 * @property {HTMLElement} [target] The target element
 */
/**
 * Drag event
 * @event H5P.PimenkoDragText#drag
 * @type {H5P.PimenkoDragTextEvent}
 */
/**
 * Drop event
 * @event H5P.PimenkoDragText#drop
 * @type {H5P.PimenkoDragTextEvent}
 */
/**
 * Revert event
 * @event H5P.PimenkoDragText#revert
 * @type {H5P.PimenkoDragTextEvent}
 */
/**
 * Start event
 * @event H5P.PimenkoDragText#start
 * @type {H5P.PimenkoDragTextEvent}
 */
/**
 * Stop event
 * @event H5P.PimenkoDragText#stop
 * @type {H5P.PimenkoDragTextEvent}
 */
/**
 * Drag Text module
 ...
 */
H5P.PimenkoDragText = (function ($, Question, ConfirmationDialog) {
    //CSS Main Containers:
     ...
     * Initialize module.
     *
     * @class H5P.PimenkoDragText
     * @extends H5P.Question
     * @param {Object} params Behavior settings
     * @param {Number} contentId Content identification
     * @param {Object} contentData Object containing task specific content data
     *
     * @returns {Object} PimenkoDragText Drag Text instance
     */
    function PimenkoDragText(params, contentId, contentData) {
        this.$ = $(this);
    ...
    PimenkoDragText.prototype = Object.create(Question.prototype);
    PimenkoDragText.prototype.constructor = PimenkoDragText;
     ...
     * @param event
     */
    PimenkoDragText.prototype.updateDroppableElement = function (event) {
     ...
     */
    PimenkoDragText.prototype.removeControlsFromDropZonesIfAllEmpty = function () {
     ...
     */
    PimenkoDragText.prototype.removeControlsFromEmptyDropZones = function () {
        this.droppables
     ...
     */
    PimenkoDragText.prototype.addAllDroppablesToControls = function () {
     ...
     */
    PimenkoDragText.prototype.removeAllDroppablesFromControls = function () {
        this.droppables
            .map(droppable => droppable.getElement())
     ...
     * Remove all drop zones from drop keyboard controls
     */
    PimenkoDragText.prototype.anyDropZoneHasDraggable = function () {
     ...
     * @param {number} index
     */
    PimenkoDragText.prototype.setDroppableLabel = function (dropZone, text, index) {
     ...
     */
    PimenkoDragText.prototype.registerDomElements = function () {
     ...
     */
    PimenkoDragText.prototype.initPimenkoDragText = function () {
        this.$inner = $('<div/>', {
     ...
     */
    PimenkoDragText.prototype.resize = function () {
     ...
     */
    PimenkoDragText.prototype.changeLayoutToFitWidth = function () {
        var self = this;
     ...
     */
    PimenkoDragText.prototype.addButtons = function () {
        var self = this;
        ...
        self.addButton('show-solution', self.params.showSolution, function () {
            $('.h5p-dragtext-feedback').addClass('h5p-hide');
            $('.h5p-dragtext-solutioncustomtext').addClass('h5p-dragtext-visible');
     ...
     * list.
     */
    PimenkoDragText.prototype.removeAllElementsFromDragControl = function () {
     ...
     *
     * @fires H5P.PimenkoDragText#start
     */
    PimenkoDragText.prototype.keyboardDraggableSelected = function (event) {
     ...
     */
    PimenkoDragText.prototype.focusOnFirstEmptyDropZone = function () {
     ...
     * @return {boolean}
     */
    PimenkoDragText.prototype.isElementDisabled = function (element) {
     ...
     * @param {ControlsEvent} event
     */
    PimenkoDragText.prototype.keyboardDroppableSelected = function (event) {
        var self = this;
     ...
     * Initialize drag text task
     */
    PimenkoDragText.prototype.toggleDraggablesContainer = function () {
     ...
     */
    PimenkoDragText.prototype.createConfirmResetDialog = function (callback, scope) {
        var self = this;
     ...
     */
    PimenkoDragText.prototype.showDropzoneFeedback = function () {
     ...
     */
    PimenkoDragText.prototype.showExplanation = function () {
        const self = this;
        let explanations = [];
     ...
     */
    PimenkoDragText.prototype.showEvaluation = function (skipXapi) {
        this.hideEvaluation();
        ...
        htmlcontentsolutiontext.innerHTML = this.params.solutionCustomText;

        var htmlcontent = "<div class='h5p-dragtext-solutioncustomtext'>"+ htmlcontentsolutiontext.textContent +"</div>";
        htmlcontent += "<div class='h5p-dragtext-feedback'>" + scoreText + "</div>";

        this.setFeedback(htmlcontent, score, maxScore, this.params.scoreBarLabel);
     ...
     * @returns {number}
     */
    PimenkoDragText.prototype.calculateScore = function () {
     ...
     */
    PimenkoDragText.prototype.hideEvaluation = function () {
        this.removeFeedback();
        this.trigger('resize');
    };
     ...
     */
    PimenkoDragText.prototype.hideExplanation = function () {
        this.setExplanation();
        this.trigger('resize');
    };
     ...
     */
    PimenkoDragText.prototype.hideAllSolutions = function () {
     ...
     */
    PimenkoDragText.prototype.addTaskTo = function ($container) {
        var self = this;
        self.widest = 0;
     ...
     * @returns {boolean}
     */
    PimenkoDragText.prototype.isAnswerPart = function (part) {
     ...
     */
    PimenkoDragText.prototype.addDropzoneWidth = function () {
        var self = this;
        var widest = 0;
     ...
     */
    PimenkoDragText.prototype.createDraggable = function (answer) {
        var self = this;
     ...
     */
    PimenkoDragText.prototype.createDroppable = function (answer, tip, correctFeedback, incorrectFeedback) {
        var self = this;
        ...
        var $dropzone = $('<div/>', {
            ...
            .droppable({
                ...
                drop: function (event, ui) {
                    ...
                    /**
                     * Note that drop will run for all initialized PimenkoDragText dropzones globally. Even other
                     * PimenkoDragTexts instances. Thus if no matching draggable or droppable is found
     ...
     * @returns {boolean}
     */
    PimenkoDragText.prototype.propagateDragEvent = Util.curry(function (eventName, self, event) {
     ...
     *
     * @fires H5P.PimenkoDragText#revert
     * @fires Question#resize
     */
    PimenkoDragText.prototype.revert = function (draggable) {
     ...
     *
     * @fires H5P.PimenkoDragText#revert
     * @fires H5P.PimenkoDragText#drop
     * @fires Question#resize
     */
    PimenkoDragText.prototype.drop = function (draggable, droppable) {
        var self = this;
        self.answered = true;
     ...
     * @returns {H5P.TextDraggable[]}
     */
    PimenkoDragText.prototype.shuffleAndAddDraggables = function ($container) {
     ...
     */
    PimenkoDragText.prototype.setDraggableAriaLabel = function (draggable) {
     ...
     * @returns {boolean}
     */
    PimenkoDragText.prototype.isGrabbed = function (element) {
     ...
     * @returns {H5P.TextDraggable}
     */
    PimenkoDragText.prototype.addDraggableToContainer = function ($container, draggable) {
     ...
     * @returns {H5P.TextDraggable}
     */
    PimenkoDragText.prototype.addDraggableToControls = function (controls, draggable) {
     ...
     */
    PimenkoDragText.prototype.instantFeedbackEvaluation = function () {
        var self = this;
     ...
     */
    PimenkoDragText.prototype.isAllAnswersFilled = function () {
     ...
     */
    PimenkoDragText.prototype.enableAllDropzonesAndDraggables = function () {
     ...
     */
    PimenkoDragText.prototype.disableDraggables = function () {
     ...
     */
    PimenkoDragText.prototype.enableDraggables = function () {
        this.draggables.forEach(function (entry) {
     ...
     */
    PimenkoDragText.prototype.getAnswerGiven = function () {
     ...
     */
    PimenkoDragText.prototype.getScore = function () {
     ...
     */
    PimenkoDragText.prototype.getMaxScore = function () {
     ...
     */
    PimenkoDragText.prototype.getTitle = function () {
     ...
     */
    PimenkoDragText.prototype.toggleDropEffect = function () {
        var hasSelectedElement = this.selectedElement !== undefined;
     ...
     * @returns {H5P.TextDraggable}
     */
    PimenkoDragText.prototype.getDraggableByElement = function (el) {
     ...
     * @returns {H5P.TextDroppable}
     */
    PimenkoDragText.prototype.getDroppableByElement = function (el) {
     ...
     */
    PimenkoDragText.prototype.showSolutions = function () {
     ...
     */
    PimenkoDragText.prototype.resetTask = function () {
        var self = this;
        // Reset task answer
        self.answered = false;
        self.instantFeedbackEvaluationFilled = false;
     ...
     */
    PimenkoDragText.prototype.resetDraggables = function () {
     ...
     */
    PimenkoDragText.prototype.getCurrentState = function () {
     ...
     */
    PimenkoDragText.prototype.setH5PUserState = function () {
        const self = this;
     ...
     * @return {boolean}
     */
    PimenkoDragText.prototype.isValidIndex = function (index) {
     ...
     * @return {Draggable}
     */
    PimenkoDragText.prototype.getDraggableByInitialIndex = function (initialIndex) {
     ...
     */
    PimenkoDragText.prototype.getXAPIData = function () {
        var xAPIEvent = this.createXAPIEventTemplate('answered');
        this.addQuestionToXAPI(xAPIEvent);
        this.addResponseToXAPI(xAPIEvent);
        return {
     ...
     * @param xAPIEvent
     */
    PimenkoDragText.prototype.addQuestionToXAPI = function (xAPIEvent) {
     ...
     * @returns {Object}
     */
    PimenkoDragText.prototype.getxAPIDefinition = function () {
        var definition = {};
     ...
     */
    PimenkoDragText.prototype.addResponseToXAPI = function (xAPIEvent) {
        var self = this;
     ...
     */
    PimenkoDragText.prototype.getXAPIResponse = function () {
     ...
     * @returns {string}
     */
    PimenkoDragText.prototype.replaceSolutionsWithBlanks = function (question) {
     ...
     */
    PimenkoDragText.prototype.getSolutionsFromQuestion = function (question) {
        return parseText(question)
 ...
 * ]
 *
 * @param {string} question Question text for an H5P.PimenkoDragText content item
 */
H5P.PimenkoDragText.parseText = function (question) {
...
export default H5P.PimenkoDragText;